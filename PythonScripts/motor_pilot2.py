...
def publish_motor_command(direction, left, right): # subroutine
	motor_data.data[0] = direction
	motor_data.data[1] = left
	motor_data.data[2] = right
